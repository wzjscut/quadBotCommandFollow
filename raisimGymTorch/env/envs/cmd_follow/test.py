...
from raisimGymTorch.env.bin import cmd_follow
...
env = VecEnv(cmd_follow.RaisimGymEnv(home_path + "/rsc", dump(cfg['environment'], Dumper=RoundTripDumper)), cfg['environment'])
